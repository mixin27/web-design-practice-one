...
const filterButtons = document.querySelector("#filter-lists").children;
...
/* Testimonials */
const slideContainer = document.querySelector(".testi-slider");
...
function changeSlide(currentSlide) {
    ...
    // animate slide
    slideContainer.style.marginLeft =- (containerWidth * currentSlide) + "px"
}
